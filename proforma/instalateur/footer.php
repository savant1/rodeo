...
<?php if (!isset($no_visible_elements) || !$no_visible_elements) { ?>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://php237.com" target="_blank">Ferry Francois
                BAKONGO</a> 2015 - <?php echo date('Y') ?></p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Powered by: <a href="http://php237.com" target="_blank">Ferry francois
                BAKONGO</a></p>
    </footer>
<?php } ?>
