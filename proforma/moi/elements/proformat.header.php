...
<table  width="851" border="2" cellspacing="2" cellpadding="2">
    ...
    <tr>
        <td style="border:hidden"  height="49" colspan="11">
            ...
            <span style="text-align: center;font-size: 1.2em;float: right;border: 1px solid black;">installateur :<?php echo $_SESSION['nom_admin'];?>
                <br>Télèphone : <?php echo $_SESSION['admin_tel'];?>
            </span>
        </td>
    </tr>
    <tr>
