<?php include 'config.php'; include '../contr/controller.php' ?>
<!DOCTYPE html>
<html lang="en">
<head>
<head>
        ...
        <div class="navbar-inner">
            ...
            <div class="btn-group pull-right">
                <button class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                    <i class="glyphicon glyphicon-user"></i><span class="hidden-sm hidden-xs"> <?php echo $_COOKIE['admin'];?></span>
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="cree_tech.php"><i class="glyphicon glyphicon-list-alt"></i><span> Cree un utlisateur</span></a> </li>
