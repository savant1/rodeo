...
<head>
    ...
    <style type="text/css">
        ...
        -->
        body{
            background-image: url("LOGO-RODEO.jpg");
...
<table  width="851" border="2" cellspacing="2" cellpadding="2">
    ...
    <tr>
        <td style="border:hidden"  height="49" colspan="11">
            <img src="LOGO-RODEO.jpg" alt="logo rodeo" width="120" height="120" /> 
            <span style="text-align: center;font-size: 1.2em;float: right;border: 1px solid black;">installateur :<?php echo $_SESSION['nom_tech'];?>
                <br>Télèphone : <?php echo $_SESSION['tel_tech'];?>
            </span>
        </td>
    </tr>
    <tr>
