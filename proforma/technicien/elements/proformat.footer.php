<tr>
    ...
    <td style="text-align: center;" colspan="2"><strong><?php echo number_format($_SESSION['stt'], 0, ',', '');?></strong></td>
  </tr>
  <tr>
    <td style="border:hidden">&nbsp;</td>
    <td style="border:hidden" colspan="5">&nbsp;</td>
  ...
  <tr>
    ...
    <td style="text-align: center;" colspan="2"><strong><?php //echo number_format($_SESSION['tvat'], 0, ',', '');?></strong></td>
  </tr>

  <tr>
    <td style="border:hidden">&nbsp;</td>
    <td style="border:hidden" colspan="5">&nbsp;</td>
    <td style="text-align: center;" colspan="2"><div align="right"><strong>TOTAL TTC. </strong></div></td>
    <td style="text-align: center;" colspan="2"><strong><?php echo number_format($_SESSION['stt'], 0, ',', '');?></strong></td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="border:hidden" >&nbsp;</td>
    <td style="border:hidden" colspan="5"><strong><u>Arr&ecirc;t&eacute;e la pr&eacute;sente PROFORMA au montant hors taxe  &agrave; la somme de :</u></strong></td>
    <td style="border:hidden" colspan="2"><strong><?php echo number_format($_SESSION['stt'], 0, ',', '');?> </strong></td>
    <td style="border:hidden" colspan="2"><strong>FRANCS CFA</strong></td>
  </tr>
  <td style="border:hidden" >&nbsp;</td>
    <td style="border:hidden" colspan="5">&nbsp;</td>
    <td style="border:hidden" colspan="2">&nbsp;</td>
    <td style="border:hidden" colspan="2">&nbsp;</td>
  <tr>
    <td style="border:hidden" colspan="11"><span class="Style2">Invest Logistic Sarl au capital de 1 000 000 FCFA,  RC n&deg; DLA/2008/B/717, NIU : M040800024807P  BP 567 DOUALA,  si&egrave;ge Douala,     1270, rue Gallieni Akwa.  www.invest-logistic.net  e.mail : yemba@invest-logistic.net   . T&eacute;l. : / 33 11 33 00 / 33 16 34 34</span></td>
  </tr>
...
<a href="../ui.php" style="border-radius: 2px;border: 1px solid #bb1813;text-decoration: none;background-color: #0063DC;font-size:22px;color: #fff0eb">Rentrer a l'édition PROFORMA</a>
</body>
</html>